...
main(Answer) :-
    ...
    /* Expresing the clues as constraints */
    Sagittarius #> Landyn,
    Soup #< Aries,
    B550 #\= Soup,
    all_different([B760,B960,Soup,Skylar,Pisces]),
    /* The semicolon represents "or" */
    (Sagittarius #= Pickles ; Virgo #= Pickles),
    Pisces #\= Wings,
    Pickles #= Kayla,
    Virgo #= B960,
    Kayla #< Skylar,
    ((Perla #=B1610,PSkins #=B960); (Perla #= B960; PSkins #=B1610)),
    label(All).
